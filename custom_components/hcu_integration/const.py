...
HCU_DEVICE_TYPES = ("HOME_CONTROL_ACCESS_POINT", "WIRED_ACCESS_POINT", "ACCESS_POINT")
HCU_MODEL_TYPES = ("HmIP-HAP", "HmIP-HCU1-A")
...
HMIP_FEATURE_TO_ENTITY = {
    ...
    "currentPower": {"class": "HcuGenericSensor", "name": "Current Power", "unit": UnitOfPower.WATT, "device_class": SensorDeviceClass.POWER, "state_class": SensorStateClass.MEASUREMENT},
